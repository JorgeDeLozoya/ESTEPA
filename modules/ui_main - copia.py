...
"")
        ...
        self.label_2 = QLabel(self.Home_Window)
...
"color:rgb(52, 141, 232)")
        ...
        icon5.addFile(u":/icons/images/icons/cil-find-in-page.png", QSize(), QIcon.Normal, QIcon.On)
...
"color:rgb(52, 141, 232)")
        icon8 = QIcon()
        icon8.addFile(u"images/icons/cil-clipboard.png", QSize(), QIcon.Normal, QIcon.Off)
        icon8.addFile(u":/icons/images/icons/cil-cloud-upload.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        self.label_6 = QLabel(self.Home_Window)
        ...
        self.label = QLabel(self.Home_Window)
        self.label.setObjectName(u"label")
        self.label.setMinimumSize(QSize(274, 10))
        self.label.setMaximumSize(QSize(345, 60))
        self.label.setStyleSheet(u"font: 25 30pt \"Microsoft JhengHei Light\";")
        ...
        self.label_5 = QLabel(self.Home_Window)
        ...
        self.label_5.setMinimumSize(QSize(351, 20))
        self.label_5.setMaximumSize(QSize(330, 100))
        self.label_5.setStyleSheet(u"font: 75 65pt \"Microsoft JhengHei\";")
        ...
        self.label_3 = QLabel(self.Home_Window)
...
"")
        ...
        self.Options_Layout.setWidget(1, QFormLayout.LabelRole, self.label_3)

        self.btn_ppg_9 = QPushButton(self.Home_Window)
...
"color:rgb(52, 141, 232)")
        ...
        icon9.addFile(u":/icons/images/icons/cil-wallet.png", QSize(), QIcon.Normal, QIcon.On)
        self.btn_ppg_9.setIcon(icon9)

        self.Options_Layout.setWidget(4, QFormLayout.LabelRole, self.btn_ppg_9)
...
"color:rgb(52, 141, 232)")
        ...
        self.Options_Layout.setWidget(6, QFormLayout.LabelRole, self.btn_ppg_6)
...
"color:rgb(52, 141, 232)")
        ...
        self.Options_Layout.setWidget(7, QFormLayout.LabelRole, self.btn_ppg_7)
...
"color:rgb(52, 141, 232)")
        icon12 = QIcon()
        icon12.addFile(u"../Users/Jorge/.designer/backup/images/icons/cil-folder-open.png", QSize(), QIcon.Normal, QIcon.Off)
        icon12.addFile(u":/icons/images/icons/cil-user.png", QSize(), QIcon.Normal, QIcon.On)
        self.btn_ppg_8.setIcon(icon12)
        ...
        self.labelVersion_13 = QLabel(self.files)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/images/icons/cil-loop-circular.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btnLoadFiles.setIcon(icon14)

        self.gridLayout_13.addWidget(self.btnLoadFiles, 4, 0, 1, 1)

        self.labelVersion_14 = QLabel(self.files)
        ...
        self.stackedWidget_2 = QStackedWidget(self.files)
        self.stackedWidget_2.setObjectName(u"stackedWidget_2")
        self.stackedWidget_2.setMinimumSize(QSize(30, 30))
        self.loaded = QWidget()
        ...
        self.btnCorrelationFiles.setIcon(icon14)
        ...
        self.btnAnalyzeFiles.setIcon(icon14)
        ...
        self.stackedWidget_2.addWidget(self.loaded)
        self.not_loaded = QWidget()
        self.not_loaded.setObjectName(u"not_loaded")
        self.stackedWidget_2.addWidget(self.not_loaded)
        ...
        self.btnCorrelationBBDD.setIcon(icon14)
        ...
        self.btnAnalyzeBBDD.setIcon(icon14)
        ...
        self.stackedWidget_3 = QStackedWidget(self.estepa)
        ...
        self.labelVersion_20 = QLabel(self.data)
...
"}")
        ...
        self.btnClear_DataValues = QPushButton(self.data)
...
"}")
        icon17 = QIcon()
        icon17.addFile(u":/icons/images/icons/cil-x.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btnClear_DataValues.setIcon(icon17)
        ...
        self.txtCurrentParameter = QLineEdit(self.data)
        ...
        self.txtCurrentParameter.setMaximumSize(QSize(110, 30))
        self.txtCurrentParameter.setCursor(QCursor(Qt.ArrowCursor))
...
"}")
        icon18 = QIcon()
        icon18.addFile(u":/icons/images/icons/cil-chevron-right.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btnNextParam.setIcon(icon18)
        ...
        self.labelVersion_21 = QLabel(self.data)
...
"}")
        icon19 = QIcon()
        icon19.addFile(u"images/icons/cil-clone.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btnCopyDescription_3.setIcon(icon19)

        self.horizontalLayout_7.addWidget(self.btnCopyDescription_3)

        self.btnClear_ParametersResult = QPushButton(self.data)
...
"	background-color: #333333; border: none;\n"
"}")
        self.btnClear_ParametersResult.setIcon(icon17)
        ...
        self.stackedWidget_3.addWidget(self.data)
        self.no_data = QWidget()
        self.no_data.setObjectName(u"no_data")
        self.stackedWidget_3.addWidget(self.no_data)
        ...
        self.GRAPH_WIDGET = QStackedWidget(self.estepa)
        ...
        self.labelVersion_22 = QLabel(self.graph)
        self.labelVersion_22.setObjectName(u"labelVersion_22")
        self.labelVersion_22.setMinimumSize(QSize(90, 0))
        self.labelVersion_22.setMaximumSize(QSize(90, 20))
        ...
        self.btnTheme = QPushButton(self.graph)
...
"}")
        ...
        self.checkBox = QCheckBox(self.graph)
        ...
        self.btnClearDescription_4 = QPushButton(self.graph)
...
"	background-color: #333333; border: none;\n"
"}")
        self.btnClearDescription_4.setIcon(icon17)
        ...
        self.GRAPH_WIDGET.addWidget(self.graph)
        self.no_graph = QWidget()
        self.no_graph.setObjectName(u"no_graph")
        self.GRAPH_WIDGET.addWidget(self.no_graph)

        self.horizontalLayout_8.addWidget(self.GRAPH_WIDGET)
        ...
        self.stackedWidget_4 = QStackedWidget(self.estepa)
        self.stackedWidget_4.setObjectName(u"stackedWidget_4")
        self.no_wafermap = QWidget()
        self.no_wafermap.setObjectName(u"no_wafermap")
        self.stackedWidget_4.addWidget(self.no_wafermap)
        ...
        self.labelVersion_23 = QLabel(self.wafermap)
...
"}")
        ...
        self.btnClearDescription_5 = QPushButton(self.wafermap)
...
"	background-color: #333333; border: none;\n"
"}")
        self.btnClearDescription_5.setIcon(icon17)
        ...
        self.stackedWidget_4.addWidget(self.wafermap)

        self.horizontalLayout_8.addWidget(self.stackedWidget_4)
...
"	background-color: #333333; border: none;\n"
"}")
        self.next_histogram_3.setIcon(icon18)
        ...
        self.btnConsult.setIcon(icon14)
...
"	background-color: #333333; border: none;\n"
"}")
        self.btnCopyDescription_4.setIcon(icon19)
...
"	background-color: #333333; border: none;\n"
"}")
        self.btnClearDescription_6.setIcon(icon17)
...
"	background-color: #333333; border: none;\n"
"}")
        self.next_histogram_2.setIcon(icon18)
...
"	background-color: #333333; border: none;\n"
"}")
        self.btnClearDescription_8.setIcon(icon17)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/icons/images/icons/cil-cloud-upload.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btnUploadFiles.setIcon(icon20)
...
"	background-color: #333333; border: none;\n"
"}")
        self.btnClearImportReport.setIcon(icon17)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-weight:590;\">ESTEPA<br/></span></p></body></html>", None))
