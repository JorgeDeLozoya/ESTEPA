...
class StatisticsEstepa():
	...
	def print_correlation(self):																					###
		...
		print_correlation +=" - a:   \t" + "\n" 
		print_correlation +=" - b:   \t" + "\n"
		print_correlation +=" - siga:   \t" + "\n"
		print_correlation +=" - sigb:   \t" + "\n"
		print_correlation +=" - chi2:   \t" + "\n"
	...
	def correlation_methods(self):
		...
		if self.config["Corr. method"] in self.corr_methods:
			if self.config["Corr. method"]=="Pearson" and len(self.data_list_ori)>2:
				...
				# method Spearman
				# scipy.stats.spearmanr(self.data_list_ori, data.list2)[0]   # Spearman's rho
				# scipy.stats.spearmanr(self.data_list_ori, data.list2).correlation   # Spearman's rho
				pass
