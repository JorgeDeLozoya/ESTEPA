...
def print_results(self):
	print_result = self.param + "\n"
	print_result += " - Mean:   \t" + str(self.mean)
	print_result += " - Median:   \t" + str(self.median)
	print_result += " - Stdev:   \t" + str(self.stdev)
	print_result += " - Points:   \t" + str(self.points_ini) + "/" + str(self.points_end)
	print_result += "\n"
